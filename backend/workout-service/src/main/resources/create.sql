create table tb_workout (date TIMESTAMP WITHOUT TIME ZONE, id bigint generated by default as identity, user_id bigint, name varchar(255), primary key (id));
create table tb_workout_item (rest integer, set_number integer, weight integer, exercise_id bigint, id bigint generated by default as identity, workout_id bigint, reps varchar(255), primary key (id));
alter table if exists tb_workout_item add constraint FKg7krac72fnjpl95ybc860c2c0 foreign key (workout_id) references tb_workout;
